...
export default function BaseFolha() {
    ...
    // ==================================================================
    // CONFIGURAÇÃO FIXA DA VISÃO DE FOLHA DE PAGAMENTO
    // ==================================================================
    const TITULO_PAGINA = "Folha de Pagamento";
    const ENDPOINT_FOLHA = "folha-pagamento-tabular";
    
    const COLUNAS_SEM_SELECT = [
        "nome", 
        "cpf", 
        "dataNascimento", 
        "dataAdmissao", 
    ...
    const fazerFetchConsolidado = (banco) => {
        ...
        let url = `${API_URL}/${banco}/${ENDPOINT_FOLHA}`;
            ...
            <Card title={`📊 ${TITULO_PAGINA}`}> 
                {loading ? (
                    ...
                    <div className="table-container">
                        ...
                        <Table columns={COLUNAS_FOLHA} data={dadosFiltrados} />
                    </div>
                ) : (
                    <div className="state-container">
